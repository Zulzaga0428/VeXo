...
// Server-side upload for admin-curated free-prompt preview media (image or
// short video). Private store -> public proxy URL.
export async function POST(request: Request) {
  try {
    ...
    const { url } = await uploadPublicMedia("prompt-library", file)
